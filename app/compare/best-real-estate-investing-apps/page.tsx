...
export const metadata: Metadata = {
  title: "Best Real Estate Investing Apps 2026: Ranked | Brickwise",
  description:
    "Lofty, Fundrise, Arrived, Ark7, and RealT compared on minimum investment, distribution frequency, and mobile experience. Independent 2026 ranking.",
  keywords: [
