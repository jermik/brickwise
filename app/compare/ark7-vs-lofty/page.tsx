...
export const metadata: Metadata = {
  title: "Ark7 vs Lofty (2026): Regulated vs Tokenized | Brickwise",
  description:
    "Ark7 vs Lofty: regulated securities ($20 min) vs daily USDC blockchain tokens ($50 min). Structure, liquidity, and best-fit investors compared.",
  keywords: [
    "ark7 vs lofty",
    "lofty vs ark7",
    "ark7 vs lofty.ai",
