...
export const metadata: Metadata = {
  title: { absolute: "Ark7 vs Lofty (2026): Securities vs Tokens | Brickwise" },
  description:
    "Ark7 vs Lofty: monthly regulated securities ($20 min) versus daily USDC tokens ($50 min). Structure, liquidity, and best-fit investors compared.",
  keywords: [
    "ark7 vs lofty",
    "lofty vs ark7",
    "ark7 vs lofty.ai",
