...
export const metadata: Metadata = {
  title: "Ark7 vs Lofty (2026): Securities vs Tokens | Brickwise",
  description:
    "Ark7 vs Lofty: regulated securities ($20 min, monthly cashflow) versus blockchain tokens ($50 min, daily USDC). Structure, liquidity, and who each is best for.",
  keywords: [
    "ark7 vs lofty",
    "lofty vs ark7",
    "ark7 vs lofty.ai",
