...
export const metadata: Metadata = {
  title: { absolute: "Best Fractional Real Estate Platforms 2026 | Brickwise" },
  description:
    "Independent comparison of Lofty, RealT, Fundrise, Arrived, and Ark7. Minimums, liquidity, distribution frequency, and who each platform is best for.",
  keywords: [
