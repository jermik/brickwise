...
export const metadata: Metadata = {
  title: "Lofty vs Arrived (2026): Tokens vs Rentals | Brickwise",
  description:
    "Lofty vs Arrived: tokenized real estate ($50 min, daily USDC payouts) versus traditional fractional rentals ($100 min, quarterly distributions).",
  keywords: [
    "lofty vs arrived",
    "arrived vs lofty",
