...
export const metadata: Metadata = {
  title: "Lofty vs Arrived: Token vs Traditional Rental | Brickwise",
  description:
    "Lofty vs Arrived: $50 minimum tokenized rentals with daily USDC payouts versus $100 minimum fractional rentals with quarterly distributions.",
  keywords: [
    "lofty vs arrived",
    "arrived vs lofty",
