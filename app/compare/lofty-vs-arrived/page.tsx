...
export const metadata: Metadata = {
  title: "Lofty vs Arrived (2026): Platform Comparison | Brickwise",
  description:
    "Lofty vs Arrived: tokenized real estate ($50 min, daily USDC) versus traditional fractional rentals ($100 min, quarterly). Independent editorial comparison.",
  keywords: [
    "lofty vs arrived",
    "arrived vs lofty",
