...
export const metadata: Metadata = {
  title: "RealT vs Fundrise (2026): Token vs eREIT | Brickwise",
  description:
    "RealT vs Fundrise: tokenized direct ownership of single properties vs diversified eREIT fund shares. Structure, minimums, liquidity, and best-fit investors.",
  keywords: [
    "realt vs fundrise",
    "fundrise vs realt",
