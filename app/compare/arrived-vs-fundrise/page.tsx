...
export const metadata: Metadata = {
  title: { absolute: "Arrived vs Fundrise (2026): Property vs Fund | Brickwise" },
  description:
    "Arrived vs Fundrise: individual rental properties ($100 min) versus diversified eREIT pools ($10 min). Minimums, liquidity, and best-fit investors compared.",
  keywords: [
    "arrived vs fundrise",
    "fundrise vs arrived",
