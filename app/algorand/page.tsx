...
export const metadata: Metadata = {
  title: `Algorand Ecosystem (${ALGORAND_TOTAL_COUNT}+ Projects) — RWA & DeFi | Brickwise`,
  description: `${ALGORAND_TOTAL_COUNT}+ Algorand ecosystem projects — wallets, DEXs, DeFi, NFT marketplaces, infrastructure, and developer tooling. Curated by Brickwise.`,
  keywords: [
    "Algorand ecosystem",
    "Algorand projects",
    "Algorand DeFi",
