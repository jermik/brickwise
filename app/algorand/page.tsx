...
export const metadata: Metadata = {
  title: { absolute: `Algorand Ecosystem — ${ALGORAND_TOTAL_COUNT}+ Projects | Brickwise` },
  description: `${ALGORAND_TOTAL_COUNT}+ Algorand ecosystem projects — wallets, DEXs, DeFi, NFT marketplaces, infrastructure, and developer tooling. Independent directory, curated by Brickwise.`,
  keywords: [
    "Algorand ecosystem",
    "Algorand projects",
    "Algorand DeFi",
