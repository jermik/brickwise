...
export const metadata: Metadata = {
  ...
  description: `${PROPERTIES.length} tokenized properties scored for yield, risk, and fair value on Lofty & RealT. Independent buy/hold/avoid signals, updated daily.`,
  keywords: [
