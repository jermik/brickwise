...
> = {
  "highest-yield": {
    title: "Highest Yield Tokenized Real Estate",
  ...
  "buy-signals": {
    title: "Tokenized Real Estate Buy Signals",
  ...
  undervalued: {
    title: "Undervalued Tokenized Real Estate",
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: { absolute: `${meta.title} | Brickwise` },
