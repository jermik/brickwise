...
export const metadata: Metadata = {
  title: { absolute: "Lofty Review 2026: Yields, Fees & Risks | Brickwise" },
  description:
    "Honest Lofty review: $50 minimum, daily USDC payouts, Algorand tokens. Real yields, fees, liquidity, and who it's best for. Data from 100+ properties.",
  keywords: [
    "lofty review",
    "lofty.ai review",
