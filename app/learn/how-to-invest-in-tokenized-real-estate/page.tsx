...
export const metadata: Metadata = {
  title: "How to Invest in Tokenized Real Estate: Guide | Brickwise",
  description:
    "$50 minimum to start. Step-by-step guide to investing in tokenized real estate: platform selection, KYC, and daily rental income explained.",
  keywords: [
