...
export const metadata: Metadata = {
  ...
  description:
    "Beginner's guide to investing in tokenized real estate. Choose a platform, complete KYC, buy your first token, and start earning daily rental income from $50.",
  keywords: [
