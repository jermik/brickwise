...
export const metadata: Metadata = {
  title: "What Is Tokenized Real Estate? 2026 Guide | Brickwise",
  description:
    "Tokenized real estate converts property ownership into blockchain tokens from $50. Learn how it works, typical yields (8–14%), and key risks.",
  keywords: [
