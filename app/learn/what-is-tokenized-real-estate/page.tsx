...
export const metadata: Metadata = {
  title: { absolute: "What Is Tokenized Real Estate? Complete Guide | Brickwise" },
  description:
    "Tokenized real estate converts property into blockchain tokens for fractional ownership from $50. Learn how it works, typical yields (8–14%), and risks.",
  keywords: [
