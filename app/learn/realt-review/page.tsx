...
export const metadata: Metadata = {
  title: { absolute: "RealT Review 2026: Yields, Fees & Risks | Brickwise" },
  description:
    "In-depth RealT review based on live data from hundreds of properties. Actual yields, management fees, vacancy rates, and how RealT compares to Lofty.",
  keywords: [
    "RealT review 2026",
    "is RealT legit",
    "RealT yield review",
