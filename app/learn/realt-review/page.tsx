...
export const metadata: Metadata = {
  title: "RealT Review 2026: Yields, Fees & Risks | Brickwise",
  description:
    "In-depth RealT review from live data across hundreds of properties. Actual net yields, management fees, vacancy rates, and comparison to Lofty.",
  keywords: [
    "RealT review 2026",
    "is RealT legit",
    "RealT yield review",
